...
class Main_UI:
    ...
    def __init__(self, background_color, middle_color, right_question_color, wrong_question_color):
        ...
        self.score_label = Label(text= f"Score: 0", bg=background_color, fg="white", font="Arial 20 bold", pady= 30)
        self.high_score_label = Label(text= f"High Score: 0", bg=background_color, fg="white", font="Arial 20 bold", pady= 30)
        self.quezz_label = Label(text="", bg=middle_color, fg=background_color, font="Arial 16 bold", wraplength=320,)
        ...
        self.start_button = Button(text="SELECT", font="arial 12 italic")
        ...
        self.difficulty = ttk.Combobox( width = 24, textvariable = self.a_difficulty)
        ...
        self.start_button.grid(row=4, column=0, columnspan=2, pady= 20, ipadx= 100)
...
class Quezz_Brain:
    ...
    def get_quezz_from_the_api(self):
        try:
            ...
            with open("100 Days Of Learning Python/DAY 34 - Quizzler/Version 2/guess_data", "w") as quess_data:
                json.dump(self.data, quess_data, indent=4, ensure_ascii=False)


    def load_quezzes(self):
        try:
            with open("100 Days Of Learning Python/DAY 34 - Quizzler/Version 2/guess_data", "r") as file:
    ...
    def save_high_Score(self):
        if self.score > self.high_score:
            with open("100 Days Of Learning Python/DAY 34 - Quizzler/Version 2/high score", "w") as file:
                file.write(str(self.score))


    def load_high_score(self):
        try:
            with open("100 Days Of Learning Python/DAY 34 - Quizzler/version 2/high score", "r") as file:
